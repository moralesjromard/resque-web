      ...
      <div class="data-table-container">
        <header class="data-table-header">
          ...
          <div class="search-container">
            ...
            <InputText v-model="globalFilter" placeholder="Keyword search." class="search-input" />
          </div>
        </header>
        <DataTable 
        ...
        >
          <Column style="padding-inline: 2rem;" field="id" header="Id" sortable></Column>
          <Column field="status" header="Status" sortable></Column>
          <Column field="crime_type" header="Crime type" sortable></Column>
          <Column field="respondent_name" header="Respondent name" sortable></Column>
          <Column style="padding-inline: 2rem;" field="created_at" header="Created at" sortable></Column>
        </DataTable>
      </div>
    </div>
  </MainLayout>

  <Dialog v-model:visible="isDialogVisible" modal header="Add Complaint" style="width: 450px;">
    <template #header>
      <i class="pi pi-user-edit dialog-filecomplaint-icon"></i>
      <span class="dialog-header-text">File complaint</span>
    </template>
    <div class="form-group">
      <label class="form-label">Crime type</label>
      <Dropdown v-model="selectedCrimeType" :options="crimeTypes" optionLabel="name" placeholder="Select crime type" class="dropdown" />
    </div>
    <div class="form-group">
      <label class="form-label">Crime overview</label>
      <InputText placeholder="Tell us what happened." class="form-input" />
    </div>
    <div class="form-group">
